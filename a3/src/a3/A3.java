 ...
 *I think it's a great practice and I enjoyed it a lot
 *
 *
 *  */
...
public class A3 {
    ...
    public static boolean areMidsDiff(String s) {
        ...
        return s.length() % 2 == 0 && s.length() > 0 && s.charAt(index - 1) != s.charAt(index);
    }
    ...
    public static String protectLittles(String s) {
        ...
        for (int k= 0; k < s.length(); k= k + 1) {
            if (Character.isLowerCase(s.charAt(k)) && s.charAt(k) >= 'a' && s.charAt(k) <= 'z') {
                char charCap= Character.toUpperCase(s.charAt(k));
                sb.insert(k + index, charCap);
                index= index + 1;
            }
        }
        return sb.toString();
    ...
    public static String putCapsLast(String s) {
        ...
        for (int k= 0; k < s.length(); k= k + 1) {
            if (Character.isUpperCase(s.charAt(k)) && s.charAt(k) >= 'A' && s.charAt(k) <= 'Z') {
    ...
    * expand("35")          is "33333". */
    public static String expand(String s) {
        ...
        String newStr= str.substring(0, 1).repeat(num);
        return newStr;
    }
    ...
    public static boolean areAnagrams(String s, String t) {
        ...
        Arrays.sort(ch0);
        Arrays.sort(ch1);
        return java.util.Arrays.equals(ch1, ch0);
    }
